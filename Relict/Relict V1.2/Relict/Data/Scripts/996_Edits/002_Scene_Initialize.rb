class Battle::Scene
  ...
  def pbCreateBackdropSprites
    ...
    playerBase = nil # "Graphics/Battlebacks/" + baseFilename + "_base1" # elena
    enemyBase  = nil # "Graphics/Battlebacks/" + baseFilename + "_base1"
    messageBG  = nil # "Graphics/Battlebacks/" + messageFilename + "_message"
    # Apply graphics
    bg = pbAddSprite("battle_bg", 0, 0, battleBG, @viewport)
    bg.z = 0
    # bg = pbAddSprite("battle_bg2", 0, 0, battleBG, @viewport) # elena
    # bg.z      = 0
    # bg.mirror = true
    2.times do |side|
