...
class PokemonSave_Scene
  ...
  LOCATION_TEXT_SHADOW = MessageConfig::DARK_TEXT_SHADOW_COLOR_ALT   # Color.new(144, 240, 144)
  MALE_TEXT_BASE       = Color.new(0, 112, 248)   # Blue
  MALE_TEXT_SHADOW     = MessageConfig::DARK_TEXT_SHADOW_COLOR_ALT   # Color.new(120, 184, 232)
  FEMALE_TEXT_BASE     = Color.new(232, 32, 16)   # Red
  FEMALE_TEXT_SHADOW   = MessageConfig::DARK_TEXT_SHADOW_COLOR_ALT   # Color.new(248, 168, 184)
  OTHER_TEXT_BASE      = Color.new(0, 112, 248)   # Blue
  OTHER_TEXT_SHADOW    = MessageConfig::DARK_TEXT_SHADOW_COLOR_ALT   # Color.new(120, 184, 232)
