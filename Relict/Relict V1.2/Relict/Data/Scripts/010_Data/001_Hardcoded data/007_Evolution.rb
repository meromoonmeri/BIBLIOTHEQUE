...
GameData::Evolution.register({
  ...
  :level_up_proc => proc { |pkmn, parameter|
    next pkmn.happiness >= NEW_HAPPINESS_AMOUNT
  }
})
...
GameData::Evolution.register({
  ...
  :any_level_up  => true,   # Needs any level up
  :level_up_proc => proc { |pkmn, parameter|
    next pkmn.happiness >= NEW_HAPPINESS_AMOUNT && pkmn.male?
  }
})
...
GameData::Evolution.register({
  ...
  :any_level_up  => true,   # Needs any level up
  :level_up_proc => proc { |pkmn, parameter|
    next pkmn.happiness >= NEW_HAPPINESS_AMOUNT && pkmn.female?
  }
})
...
GameData::Evolution.register({
  ...
  :any_level_up  => true,   # Needs any level up
  :level_up_proc => proc { |pkmn, parameter|
    next pkmn.happiness >= NEW_HAPPINESS_AMOUNT && PBDayNight.isDay?
  }
})
...
GameData::Evolution.register({
  ...
  :any_level_up  => true,   # Needs any level up
  :level_up_proc => proc { |pkmn, parameter|
    next pkmn.happiness >= NEW_HAPPINESS_AMOUNT && PBDayNight.isNight?
  }
})
...
GameData::Evolution.register({
  ...
  :any_level_up  => true,   # Needs any level up
  :level_up_proc => proc { |pkmn, parameter|
    if pkmn.happiness >= NEW_HAPPINESS_AMOUNT
...
GameData::Evolution.register({
  ...
  :any_level_up         => true,   # Needs any level up
  :level_up_proc        => proc { |pkmn, parameter|
    next pkmn.item == parameter && pkmn.happiness >= NEW_HAPPINESS_AMOUNT
  },
  :after_evolution_proc => proc { |pkmn, new_species, parameter, evo_species|
...
GameData::Evolution.register({
  ...
  :parameter     => :Item,
  :use_item_proc => proc { |pkmn, parameter, item|
    next item == parameter && pkmn.happiness >= NEW_HAPPINESS_AMOUNT
  }
})
