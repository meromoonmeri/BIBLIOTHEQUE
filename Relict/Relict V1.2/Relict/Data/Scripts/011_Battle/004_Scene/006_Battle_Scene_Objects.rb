...
#    pbSetSmallFont(@hpNumbers.bitmap)
  ...
  def refresh_hp
    ...
    if @show_hp_numbers
      ...
      pbDrawNumber(self.hp, @hpNumbers.bitmap, hp_x, number_y, :right)
      pbDrawNumber(-1, @hpNumbers.bitmap, slash_x, number_y)
      pbDrawNumber(@battler.totalhp, @hpNumbers.bitmap, total_x, number_y)
    end
    # Resize HP bar
    w = 0
    if self.hp > 0
