...
GameData::Weather.register({
  ...
  :id_number        => 4,
  :category         => :Hail,
  :graphics         => [["blizzard_1", "blizzard_2", "blizzard_3", "blizzard_4"], ["blizzard_tile"]],#[["blizzard_1", "blizzard_2", "blizzard_3", "blizzard_4"], ["blizzard_tile"]],
  :particle_delta_x => -720,
  :particle_delta_y => 240,
  :tile_delta_x     => -1200,
  :tile_delta_y     => 600,
  :tone_proc        => proc { |strength|
    next Tone.new(strength * 1 / 4, strength * 1 / 4, strength * 1 / 4, 0)
  }
})
