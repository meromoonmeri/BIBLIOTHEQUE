...
class MoveRelearner_Scene
  ...
  def pbStartScene(pokemon, moves)
    ...
    @viewportBG.z = 99999
    @viewport = Viewport.new(RELEARNER_UI_X, RELEARNER_UI_Y, Graphics.width, Graphics.height)
    @viewport.z = 99999
    @viewportWindow = Viewport.new(0, 0, Graphics.width, Graphics.height)
    @viewportWindow.z = 99999
    @sprites = {}
    addBackgroundPlane(@sprites, "bg", "Move Reminder/bg", @viewportBG)
    ...
    @sprites["msgwindow"].viewport = @viewportWindow
