...
class PokemonPokedexInfo_Scene
  def pbStartScene(dexlist, index, region)
    ...
    @sprites = {}
    @sprites["backgroundBG"] = IconSprite.new(0, 0, @viewportBG)
  ...
  def drawPageInfo
    @sprites["backgroundBG"].setBitmap(_INTL("Graphics/UI/Pokedex/bg_infoBG"))
    ...
    if $player.owned?(@species)
      ...
      drawTextEx(overlay, 40, 246, 444, 4,   # overlay, x, y, width, num lines
  ...
  def drawPageForms
    @sprites["backgroundBG"].setBitmap(_INTL("Graphics/UI/Pokedex/bg_formsBG"))
    ...
    textpos = [
      [GameData::Species.get(@species).name, OLD_WIDTH / 2, OLD_HEIGHT - 82, :center, base, shadow],
      [formname, OLD_WIDTH / 2, OLD_HEIGHT - 50, :center, base, shadow]
    ]
    # Draw all text
    pbDrawTextPositions(overlay, textpos)
  end
