    ...
    2.times do |side|
      ...
      when 0
        @battle.allSameSideBattlers.each_with_index do |b, i|
          ...
          pbSetWithOutline("info_icon#{b.index}", [iconX + BATTLE_UI_X_POS, iconY + BATTLE_UI_Y_POS, 300])
      ...
      when 1
        @battle.allOtherSideBattlers.reverse.each_with_index do |b, i|
          ...
          @sprites["info_icon#{b.index}"].x = iconX
          @sprites["info_icon#{b.index}"].y = iconY
          pbSetWithOutline("info_icon#{b.index}", [iconX + BATTLE_UI_X_POS, iconY + BATTLE_UI_Y_POS, 400])
      ...
      if !trainers.empty?
        ...
        trainers.each do |array|
          ...
          imagePos.push([@path + "info_owner", ballX - 16 - BATTLE_UI_X_POS, ballY - ballOffset, 0, 0, 128, 20])
          NUM_BALLS.times do |slot|
            ...
            imagePos.push([@path + "info_party", ballX + (slot * 16) - BATTLE_UI_X_POS, ballY, idx * 15, 0, 15, 15])
          end
