...
class Battle::Scene
  ...
  # Text colors
  MESSAGE_BASE_COLOR   = MessageConfig::LIGHT_TEXT_MAIN_COLOR # Color.new(80, 80, 88)
  MESSAGE_SHADOW_COLOR = MessageConfig::DARK_TEXT_SHADOW_COLOR_ALT # Color.new(160, 160, 168)
  ...
  PLAYER_BASE_X        = 128 * 1.5 # elena
  PLAYER_BASE_Y        = Settings::SCREEN_HEIGHT - (80 * 1.4) # elena
  # Centre middle of the foe's side base graphic
  FOE_BASE_X           = Settings::SCREEN_WIDTH - (128 * 1.1) # elena
  FOE_BASE_Y           = (Settings::SCREEN_HEIGHT * 3 / 4) - (112 * 1.2) # elena
  ...
  def self.pbTrainerPosition(side, index = 0, sideSize = 1)
    # Start at the centre of the base for the appropriate side
    if side == 0
      ret = [PLAYER_BASE_X, Settings::SCREEN_HEIGHT] #elena
    else
