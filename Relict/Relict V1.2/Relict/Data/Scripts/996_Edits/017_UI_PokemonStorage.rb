...
class PokemonStorageScene
  ...
  def pbStartBox(screen, command)
    ...
    @bgviewport.z = 99999
    @boxviewport = Viewport.new(BOXES_UI_X, BOXES_UI_Y, Graphics.width, Graphics.height)
    @boxviewport.z = 99999
    @boxsidesviewport = Viewport.new(BOXES_UI_X, BOXES_UI_Y, Graphics.width, Graphics.height)
    @boxsidesviewport.z = 99999
    @arrowviewport = Viewport.new(BOXES_UI_X, BOXES_UI_Y, Graphics.width, Graphics.height)
  ...
  def pbPartySetArrow(arrow, selection)
    ...
    Settings::MAX_PARTY_SIZE.times do |i|
      ...
      yvalues.push(2 + (16 * (i % 2)) + (64 * (i / 2)) + BOXES_UI_Y * 2)
    end
    xvalues.push(236)
    yvalues.push(220 + BOXES_UI_Y * 2)
    arrow.angle = 0
    arrow.mirror = false
    arrow.ox = 0
    arrow.oy = 0
