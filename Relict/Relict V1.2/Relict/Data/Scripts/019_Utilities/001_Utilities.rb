...
def pbTrainerName(name = nil, outfit = 0, helptext = _INTL("Your name?"), suggestName = _INTL("Mallie"))
  pbChangePlayer(1) if $player.character_ID < 1
  if name.nil?
    name = pbEnterPlayerName(helptext, 0, Settings::MAX_PLAYER_NAME_SIZE, suggestName)
