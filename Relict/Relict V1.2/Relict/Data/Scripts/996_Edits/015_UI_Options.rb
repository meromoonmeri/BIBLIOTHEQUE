...
class PokemonSystem
  ...
  def initialize
    ...
    @sevolume      = 75    # Volume of sound effects
...
class Window_PokemonOption < Window_DrawableCommand
  ...
  SEL_NAME_SHADOW_COLOR  = MessageConfig::DARK_TEXT_SHADOW_COLOR_ALT # Color.new(248, 176, 80)
  SEL_VALUE_BASE_COLOR   = Color.new(248, 48, 24)
  SEL_VALUE_SHADOW_COLOR = MessageConfig::DARK_TEXT_SHADOW_COLOR_ALT # Color.new(248, 136, 128)
